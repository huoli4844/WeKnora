-- Create extensions (skip vector and pg_search for now)
...
-- Simplified embeddings table without vector support for now
CREATE TABLE IF NOT EXISTS embeddings (
    ...
    embedding TEXT -- Store as TEXT for now instead of halfvec
);
